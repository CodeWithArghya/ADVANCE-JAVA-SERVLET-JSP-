...
<div class="container m-auto">
    <h1 class="text-center text-warning mt-4">Your Task List </h1>
    <p class="text-center text-light"><b>View, Modify & Delete Task from the list</b></p>
    <table class="table table-hover table-warning">
        <thead>
            <tr>
                ...
                <th scope="col"class=" text-dark">Edit / Delete Task</th>
            </tr>
        </thead>
        <tbody>
            <%
            ...
            <tr>
                ...
                <td id="sts" class="<%= status.equals("Task Completed") ? "text-success" : "text-danger" %> text-center"><b><%= status %></b></td>
                <td>
                    <a  href="edittask.jsp?todoid=<%=todoid%>" class="text-center btn btn-info">Edit</a>
                    <a href="deletetask.jsp?todoid=<%= todoid %>" class="text-center btn btn-danger" onclick="confirmDelete(<%= todoid %>)">Delete</a>
