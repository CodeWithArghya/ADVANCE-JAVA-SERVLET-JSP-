...
<body>
  ...
  <div class="collapse navbar-collapse" id="navbarTogglerDemo03">
	...
	<div class="container">
	<h1 class="text-center text-danger">Signup Page || TODO App</h1>
	<div class="row">
	<div class=" m-auto">
		<img src="images/signup.jpg" height=400 width=500 />
	</div>
	...
	<div class="col-12 bg-primary">
		...
		<input class="form-control" type="password" name="password" placeholder="Enter a Strong Password" />
		...
		<button class="btn btn-success p-6">Signup</button>
		</div>
		<p>
		</form>
	</div>
